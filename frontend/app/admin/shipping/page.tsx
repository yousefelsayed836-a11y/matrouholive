      ...
      <div style={{ minHeight: "100vh", padding: "24px" }}>
        <div style={{ maxWidth: 900, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 24, flexWrap: "wrap", gap: 12 }}>
            ...
            <button onClick={save} style={{ padding: "12px 28px", borderRadius: 12, border: "none", background: saved ? "#22c55e" : "linear-gradient(135deg,#4B6741,#3a5232)", color: "#fff", fontWeight: 700, cursor: "pointer", fontSize: 15 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12, marginBottom: 20 }}>
            {[
              { label: "Governorates", value: rates.length, bg: "#4B674122", color: "#4B6741" },
                  ...
                  <tr key={r.name} style={{ borderBottom: "1px solid #f5f5f5", background: i % 2 === 0 ? "#fff" : "#fafafa" }}>
                    ...
                    <td style={{ padding: "12px 16px", textAlign: "center" }}>
                      <input
                        ...
                        style={{ width: 100, padding: "8px 12px", borderRadius: 8, border: "1.5px solid #c8d9b0", fontSize: 14, fontWeight: 700, textAlign: "center", outline: "none", color: "#4B6741" }}
                        onFocus={e => (e.target as HTMLInputElement).style.borderColor = "#4B6741"}
                        onBlur={e => (e.target as HTMLInputElement).style.borderColor = "#c8d9b0"}
                      />
                    </td>
                  </tr>
                ))}
          ...
          <div style={{ marginTop: 20, textAlign: "right" }}>
            <button onClick={save} style={{ padding: "14px 36px", borderRadius: 12, border: "none", background: saved ? "#22c55e" : "linear-gradient(135deg,#4B6741,#3a5232)", color: "#fff", fontWeight: 700, cursor: "pointer", fontSize: 16 }}>
